...
package com.bsoares.sneskeyboard;
 ...
 * out as appropriate.
 */
public class SNESKeyboard extends InputMethodService implements
	...
	private static final String DEVICE_ADDRESS = "00:06:66:42:0A:94";
	...
	public class ArduinoReceiver extends BroadcastReceiver {
		...
		final int SNES_B = 0x01;
		final int SNES_Y = 0x02;
		final int SNES_SELECT = 0x04;
		final int SNES_START = 0x08;
		final int SNES_UP = 0x10;
		final int SNES_DOWN = 0x20;
		final int SNES_LEFT = 0x40;
		final int SNES_RIGHT = 0x80;
		final int SNES_A = 0x100;
		final int SNES_X = 0x200;
		final int SNES_L = 0x400;
		final int SNES_R = 0x800;
		...
		public void onReceive(Context context, Intent intent) {
			...
			if (dataType == AmarinoIntent.STRING_EXTRA) {
				...
				if (data != null) {
					...
					if ((iData & SNES_SELECT) == SNES_SELECT) {
					...
					if ((iData & SNES_START) == SNES_START) {
					...
					if ((iData & SNES_RIGHT) == SNES_RIGHT) {
